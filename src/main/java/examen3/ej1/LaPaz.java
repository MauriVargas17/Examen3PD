...
public class LaPaz implements IDepto{
    ...
    public LaPaz(String name, int numberProvincias, int numberHabitantes, String clima, double dineroPorTurismo) {
        this.name = name;
    ...
    public void recibirTurista(ITurista turista) {
        dineroPorTurismo += turista.gastar(this);
    }
}
